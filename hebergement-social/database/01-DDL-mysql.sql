...
DROP TABLE IF EXISTS residents_medical_needs;
...
(
	person_id INT,
	resident_date_arrival DATETIME NOT NULL,
	resident_date_leave DATETIME NULL DEFAULT NULL, 
...
(
	medical_needs_id INT AUTO_INCREMENT PRIMARY KEY,
